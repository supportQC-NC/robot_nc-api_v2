...
app.use(
  cors({
    origin: ["http://localhost:3000", "http://robot-nc.com"],
    credentials: true,
  })
);

// Configuration des logs en mode développement
if (process.env.NODE_ENV === "development") {
  app.use(morgan("dev"));
}
...
// Fonction utilitaire pour importer dynamiquement les routes
const importRoutes = (prefix, routes) => {
  routes.forEach((route) => {
    app.use(`/api/v2/${prefix}/${route.name}`, route.module);
  });
};
...
// Import dynamique des routes pour chaque groupe
const groups = [
  { prefix: "avb", routes: ["articles", "classes", "fournisseurs", "clients", "factures", "facture-details", "tiers"] },
  { prefix: "aw", routes: ["articles", "classes", "fournisseurs", "clients", "factures", "facture-details", "tiers"] },
  { prefix: "dq", routes: ["articles", "classes", "fournisseurs", "clients", "factures", "facture-details", "tiers"] },
  { prefix: "fmb", routes: ["articles", "classes", "fournisseurs", "clients", "factures", "facture-details", "tiers"] },
  { prefix: "hd", routes: ["articles", "classes", "fournisseurs", "clients", "factures", "facture-details", "tiers"] },
  { prefix: "kone", routes: ["articles", "classes", "fournisseurs", "clients", "factures", "facture-details", "tiers"] },
  { prefix: "koumac", routes: ["articles", "classes", "fournisseurs", "clients", "factures", "facture-details", "tiers"] },
  { prefix: "ld", routes: ["articles", "classes", "fournisseurs", "clients", "factures", "facture-details", "tiers"] },
  { prefix: "leBroussard", routes: ["articles", "classes", "fournisseurs", "clients", "factures", "facture-details", "tiers"] },
  { prefix: "meare", routes: ["articles", "classes", "fournisseurs", "clients", "factures", "facture-details", "tiers"] },
  { prefix: "paitaBricolage", routes: ["articles", "classes", "fournisseurs", "clients", "factures", "facture-details", "tiers"] },
  { prefix: "qc", routes: ["articles", "classes", "fournisseurs", "clients", "factures", "facture-details", "tiers"] },
  { prefix: "sitec", routes: ["articles", "classes", "fournisseurs", "clients", "factures", "facture-details", "tiers"] },
  { prefix: "vkp", routes: ["articles", "classes", "fournisseurs", "clients", "factures", "facture-details", "tiers"] },
];

groups.forEach(({ prefix, routes }) => {
  routes.forEach((route) => {
    import(`./routes/${route}/${prefix + route}.js`).then((module) => {
      app.use(`/api/v2/${prefix}/${route}`, module.default);
    });
  });
});
