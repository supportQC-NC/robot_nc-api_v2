...
const PaitaBricolageFactureDetailsSchema = new mongoose.Schema(
  {
...
export default mongoose.model("PaitaBricolageFactureDetails", PaitaBricolageFactureDetailsSchema);
